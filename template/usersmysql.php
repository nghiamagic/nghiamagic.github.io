...
$uvon = isset($_SESSION['username']) ? $_SESSION['username'] : $_SERVER['REMOTE_ADDR'] . $vst_id;
...
$reout = '<div id="uvon"><h4>Online: '. ($nrusr+$nrvst). '</h4>Khách: '. $nrvst. '<br/>Người Dùng: '. $nrusr. '</div>';
