    ...
    <div class="pu-main" style="margin-top: 50px;">
        <div class="container">
            <div class="pu-mainbox">
                <div class="pu-shopif">
                    <div class="pu-shopif">
                        <h3 style="text-align: center;">Quản Lý ACC PUBG</h3>
...
?> 
                            <table class="table">
                                ...
                                <tbody>
<?php
$bd = mysql_query("SELECT * FROM `baidang` ORDER BY `id` DESC");
...
?>
                                    <tr>
                                       ...
                                       <td><a href="/admin/?chinhsua=<?=$posts['id']; ?>" style="color: #fff;">Sửa</a><br />
                                       <a href="/admin/?xoa=<?=$posts['id']; ?>" style="color: #fff;">Xóa</a>
                                       </td>
                                    </tr>
<?php
endwhile;
